...
% PV differences
PV_diffs = PV1_total - PV2_total(1:101,:);
figure(3)
imagesc(PV_diffs(1:101,:))
colormap(redblue(20))
colorbar('east')
set(gca,'ydir','normal')
caxis([-1.7e-10 1.7e-10])
set(gca,'ytick',[0:50:100],'yticklabel',[0:5:10])
ylabel('z(km)')
set(gca,'xtick',[0:2500:10000],'xticklabel',[-500:250:500])
xlabel('x(km)')
ylim([0 100])
