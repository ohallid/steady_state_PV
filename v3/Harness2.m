...
m1       = [1:1:mmax];
c1       = ( m1 .* m1 * pi * pi / N1 / N1 + 0.25 / ratiopp1 / ratiopp1 ) .^ -0.5; % c_n / HL_bar of document.
...
s1      = 0.5 * c1 .* c1 * A1 / scaleht1 / N1 / N1 * exp ( - 0.5 * ratiop1 )...
          .* ( ( Hkn1 .* Hkn1 * ratiopp1 * ratiopp1 + 0.25 ) .^ 0.5 ) .* ( real (w1) - real (w2) );
s1      = HL_bar * HL_bar * s1; % compensate for dimensionless c1. 
